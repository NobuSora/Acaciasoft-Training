...
<div id = "main">
  ...
  <?php  //https://www.formget.com/update-data-in-database-using-php/  to display table in echo https://stackoverflow.com/questions/35944425/displaying-a-user-profile-page-php
   require_once 'db.php';
   $count= 1;
   $query = "SELECT * FROM contactdetails WHERE contact_id = '".$_SESSION['sesID']."'  ORDER BY contact_name";
  ...
  <td class="ev">
  <a href="delete.php?deleteid=<?php echo $row["id"]; ?> "id="del" Onclick="return ConfirmDelete()">Delete</a>
